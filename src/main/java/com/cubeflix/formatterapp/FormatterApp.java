...
public class FormatterApp {
    public static void main(String[] args) throws IOException {        
        ...
        */
        ...
        TextRun run3 = new TextRun("abc", style3);
        InlineObject[] runs1 = {new Spacer(40000.0f), run1, run3};
        ...
        ParagraphStyle pgstyle = new ParagraphStyle(100.0f, ParagraphAlignment.JUSTIFY, new HyphenationSettings(true, 0.95f));
